...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.encrypt_button.setGeometry(QtCore.QRect(250, 460, 75, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_2.setGeometry(QtCore.QRect(110, 130, 61, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.txt_key.setGeometry(QtCore.QRect(220, 240, 471, 51))
        self.txt_key.setObjectName("txt_key")
        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(220, 350, 471, 71))
        ...
        self.label_4.setGeometry(QtCore.QRect(110, 350, 61, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label.setGeometry(QtCore.QRect(340, 40, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.txt_plain_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(220, 130, 471, 71))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.decrypt_button = QtWidgets.QPushButton(self.centralwidget)
        self.decrypt_button.setGeometry(QtCore.QRect(490, 460, 75, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "VIGENNE CIPHER"))
